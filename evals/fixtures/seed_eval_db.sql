...
INSERT INTO clean_jobs
  (source, external_id, source_url, title, company, role, description, tech_stack,
   job_level, location, posted_date, is_internship, salary_min, salary_max,
   salary_currency, is_salary_negotiable)
VALUES
  ('fixture', 'fixture-001', 'https://www.vietnamworks.com/ai-engineer-computer-vision-nlp-llm-khoi-cong-nghe-thong-tin-2026td450582-2069027-jv', 'AI Engineer (Computer Vision/ NLP/ LLM) - Khối Công Nghệ Thông Tin (2026TD450582)', 'NGÂN HÀNG TMCP QUÂN ĐỘI – MBBANK', 'AI Engineer',
   ...
   NULL, 'Hanoi', NULL, false, 3000, 5000,
   'USD', false),
  ('fixture', 'fixture-002', 'https://www.vietnamworks.com/ai-engineer-intern-2067168-jv', 'AI Engineer Intern', 'K&M Holdings', 'AI Engineer',
   ...
   NULL, 'Hanoi', NULL, true, 8000000, 12000000,
   'VND', false),
  ('fixture', 'fixture-003', 'https://www.vietnamworks.com/ai-engineer--2066640-jv', 'AI Engineer', 'Công Ty Cổ Phần ITL Aviation Logistics', 'AI Engineer',
   ...
   NULL, 'Ho Chi Minh City', NULL, false, 2000, 3500,
   'USD', false),
  ('fixture', 'fixture-004', 'https://www.vietnamworks.com/ai-engineer-fresherjunior-2048925-jv', 'AI Engineer ( Fresher/junior )', 'K&M Holdings', 'AI Engineer',
   ...
   NULL, 'Da Nang', NULL, true, NULL, NULL,
   NULL, true),
  ('fixture', 'fixture-005', 'https://www.vietnamworks.com/ai-engineer-middle-level-thu-nhap-20-30-trieu-2064255-jv', 'AI Engineer (Middle Level) (Thu Nhập 20-30 Triệu)', 'K&M Holdings', 'AI Engineer',
   ...
   NULL, 'Hanoi', NULL, false, 25000000, 35000000,
   'VND', false),
  ('fixture', 'fixture-006', 'https://www.vietnamworks.com/data-scientist--2071050-jv', 'Data Scientist', 'Công Ty Cổ Phần Chứng Khoán SSI', 'Data Scientist',
   ...
   NULL, 'Hanoi', NULL, false, 2500, 4000,
   'USD', false),
  ('fixture', 'fixture-007', 'https://www.vietnamworks.com/data-scientist-2074720-jv', 'Data Scientist', 'Sonat Game', 'Data Scientist',
   ...
   NULL, 'Ho Chi Minh City', NULL, false, 30000000, 40000000,
   'VND', false),
  ('fixture', 'fixture-008', 'https://www.vietnamworks.com/chuyen-vien-chuyen-vien-cao-cap-khoa-hoc-du-lieu-data-scientist-khoi-du-lieu-2026td450984-2062266-jv', 'Chuyên viên, Chuyên viên Cao cấp Khoa học Dữ liệu - Data Scientist - Khối Dữ liệu (2026TD450984)', 'NGÂN HÀNG TMCP QUÂN ĐỘI – MBBANK', 'Data Scientist',
   ...
   NULL, 'Hanoi', NULL, false, 22000000, 30000000,
   'VND', false),
  ('fixture', 'fixture-009', 'https://www.vietnamworks.com/data-scientist--2067775-jv', 'Data Scientist', 'Công Ty TNHH T.M.G', 'Data Scientist',
   ...
   NULL, 'Ho Chi Minh City', NULL, true, NULL, NULL,
   NULL, true),
  ('fixture', 'fixture-010', 'https://www.vietnamworks.com/data-engineer-senior-lead-2070494-jv', 'Data Engineer (Senior/ Lead)', 'CÔNG TY CỔ PHẦN SYNODUS', 'Data Engineer',
   ...
   NULL, 'Hanoi', NULL, false, 1800, 3000,
   'USD', false),
  ('fixture', 'fixture-011', 'https://www.vietnamworks.com/home-racer-data-engineer-2068678-jv', 'Home Racer - Data Engineer', 'Home Credit Vietnam - Explore Your Dream Team', 'Data Engineer',
   ...
   NULL, 'Ho Chi Minh City', NULL, false, 20000000, 28000000,
   'VND', false),
  ('fixture', 'fixture-012', 'https://www.vietnamworks.com/senior-data-engineer-2069837-jv', 'Senior Data Engineer', 'Công Ty TNHH Socotec Việt Nam', 'Data Engineer',
   ...
   NULL, 'Da Nang', NULL, false, NULL, NULL,
   NULL, false),
  ('fixture', 'fixture-013', 'https://www.vietnamworks.com/data-engineer--2073557-jv', 'Data Engineer', 'De Heus LLC', 'Data Engineer',
   ...
   NULL, 'Hanoi', NULL, false, 6000000, 9000000,
   'VND', false),
  ('fixture', 'fixture-014', 'https://www.vietnamworks.com/senior-aiagent-engineer-1-year-contractor-2072667-jv', 'Senior AI/Agent Engineer (1-Year Contractor)', 'Bosch Global Software Technologies Company Limited', 'ML Engineer',
   ...
   NULL, 'Hanoi', NULL, false, 2200, 3800,
   'USD', false),
  ('fixture', 'fixture-015', 'https://www.vietnamworks.com/engineersenior-engineer-of-ai-2067850-jv', 'Engineer/senior Engineer Of AI', 'Hoya Glass Disk Vietnam', 'ML Engineer',
   ...
   NULL, 'Ho Chi Minh City', NULL, false, 24000000, 34000000,
   'VND', false),
  ('fixture', 'fixture-016', 'https://www.vietnamworks.com/machine-vision-engineer-ky-su-thi-giac-may-2061678-jv', 'Machine Vision Engineer (Kỹ Sư Thị Giác Máy)', 'Công Ty TNHH Standard Units Supply Việt Nam', 'ML Engineer',
   ...
   NULL, 'Da Nang', NULL, false, 1500, 2500,
   'USD', false),
  ('fixture', 'fixture-017', 'https://www.vietnamworks.com/computer-vision-engineer-factory-automation-2061537-jv', 'Computer Vision Engineer (Factory Automation)', 'Vietnamworks'' Client', 'ML Engineer',
   ...
   NULL, 'Ho Chi Minh City', NULL, false, NULL, NULL,
   NULL, false),
  ('fixture', 'fixture-018', 'https://www.vietnamworks.com/data-analyst-2074930-jv', 'Data Analyst', 'Home Credit Vietnam - Explore Your Dream Team', 'Data Analyst',
   ...
   NULL, 'Hanoi', NULL, true, 7000000, 10000000,
   'VND', false),
  ('fixture', 'fixture-019', 'https://www.vietnamworks.com/data-analyst-after-sales-parts-business-2064342-jv', 'Data Analyst (After Sales Parts Business)', 'Công Ty TNHH Ô Tô Isuzu Việt Nam', 'Data Analyst',
   ...
   NULL, 'Ho Chi Minh City', NULL, false, NULL, NULL,
   NULL, true),
  ('fixture', 'fixture-020', 'https://www.vietnamworks.com/senior-data-analyst-2074081-jv', 'Senior Data Analyst', 'Bosch Global Software Technologies Company Limited', 'Data Analyst',
   ...
   NULL, 'Da Nang', NULL, true, 9000000, 13000000,
   'VND', false),
  ('fixture', 'fixture-021', 'https://www.vietnamworks.com/senior-data-analyst--2039989-jv', 'Senior Data Analyst', 'Công Ty Cổ Phần Chứng Khoán SSI', 'Data Analyst',
   ...
   NULL, 'Hanoi', NULL, false, NULL, NULL,
   NULL, false),
  ('fixture', 'fixture-022', 'https://www.vietnamworks.com/business-intelligence-specialist-senior-2044474-jv', 'Business Intelligence Specialist (Senior)', 'NEYU', 'Other',
   ...
   NULL, 'Ho Chi Minh City', NULL, false, 15000000, 20000000,
   'VND', false);
