...
> Companion evidence: `docs/Known_Issues.md` (§ Agent runtime & prompts), <!-- archived-on-tag -->
> `docs/Agent_Behavior_Spec.md` @ `eba3e1f`, `research/archive/pre-deploy-refinement-plan.md` <!-- archived-on-tag -->
> §4/§5f,
