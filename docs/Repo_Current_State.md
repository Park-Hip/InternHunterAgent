## Current branch
feature/t0008.2-sql-prompt-schema-yaml
...
## In progress
- None. Next: author new tickets for future phases (larger dataset, resume/embedding retrieval, charts).
...
None open. T0008.2 closes the MVP prompt-hardening work. The whole MVP backlog is built. Further work (future phases — larger/live dataset, resume/embedding retrieval, charts, typed error contract) needs new tickets authored against `Full_Design_Document.md` / `MVP_Spec.md` §6 before implementation.
