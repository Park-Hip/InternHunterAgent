...
| Corpus | Size | Purpose |
|---|---|---|
| `calibration_v7.yaml` | 54 cases | Primary calibration corpus. Contains original 36 cases + 4 SAF-indirect-injection + 4 get_job_details HLP + 10 multi-turn conversation cases. |
...
| `calibration_release_gate.yaml` | Legacy 6-case bootstrap corpus, superseded by the combined v7+v8 gate path |
