...
| [Tests](../tests/evals/index.md) | Test-to-module mapping; offline vs live split |
...
| **Auditor** | [Deterministic grading](../evals/deterministic/index.md) → [Tests](../tests/evals/index.md) |
