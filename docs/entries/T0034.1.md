...
| Documentation checks | Entry is clean; the frozen report register awaits integration rendering |
...
The integration step should fold this entry into the frozen report and verification registers.
The existing known-issue record already contains the corrected serving-window description.
