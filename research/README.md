...
| [`docs-hygiene-and-system-plan.md`](docs-hygiene-and-system-plan.md) | Plan for **M22 (Docs Hygiene & Documentation System)**, authored 2026-08-09. Measured baseline of all 46 tracked `.md` files (21% of lines over 100 chars, 15 broken path references, committed mojibake, 31% of commits docs-only); the four-tier doc model and Fact Ledger; specs for the new `Tech_Stack.md`, `Operations.md`, `Decision_Log.md` and `Docs_Conventions.md`; the `scripts/docs_lint.py` enforcement design; and the T0022.1–.9 ticket sequence. **Also records that this repo is worked by both Claude Code and Codex**, so `CLAUDE.md` and `AGENTS.md` must both stay complete. Feeds `docs/Tickets.md` → T0022. |
